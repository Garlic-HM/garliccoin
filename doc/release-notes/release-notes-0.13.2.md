Garliccoin Core version 0.13.2 is now available from:

  <https://garliccoin.org/bin/garliccoin-core-0.13.2/>
...
- #8908 `4a974b2` Update garliccoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow garliccoin-tx to create v2 transactions (gtcdrak)
