Garliccoin Core version 0.16.1 is now available from:

  <https://garliccoincore.org/bin/garliccoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting garliccoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure garliccoind processes are cleaned up when tests end (sdaftuar)
