Garliccoin Core version 0.10.4 is now available from:

  <https://garliccoin.org/bin/garliccoin-core-0.10.4/>
...
- #6953 `43c2789` Split garliccoin-tx into its own package
- #6953 `dfe0d4d` Include garliccoin-tx binary on Debian/Ubuntu
