...
Garliccoin Core version 0.19.1 is now available from:

  <https://garliccoincore.org/bin/garliccoin-core-0.19.1/>
...
From Garliccoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Garliccoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Garliccoin Core does not yet change appearance when
...
- #17488 fix "garliccoind already running" warnings on macOS (fanquake)
