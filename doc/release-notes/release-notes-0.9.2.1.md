Garliccoin Core version 0.9.2.1 is now available from:

  https://garliccoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 GTC to 0.01 GTC
...
- Fix "Start garliccoin on system login"
