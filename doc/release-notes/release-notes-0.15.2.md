Garliccoin Core version *0.15.2* is now available from:

  <https://garliccoincore.org/bin/garliccoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in garliccoin-tx (TheBlueMatt)
