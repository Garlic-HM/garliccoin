Garliccoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/garliccoin/files/Garliccoin/garliccoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Garliccoin
...
New/changed settings (command-line or garliccoin.conf file)
--------------------------------------------------------
