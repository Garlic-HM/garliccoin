Garliccoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/garliccoin/files/Garliccoin/garliccoin-0.5.4/
...
http://gitorious.org/garliccoin/garliccoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Garliccoin-Qt notifications under Growl 1.3.
Increase required age of Garliccoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGarliccoin properly when installing Garliccoin-Qt over it. (Windows)
