Garliccoin Core version 0.9.4 is now available from:

  https://garliccoin.org/bin/0.9.4/
...
this update is incompatible with the Garliccoin system and could lead to consensus
forks.

Garliccoin Core released binaries from https://garliccoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~garliccoin/+archive/ubuntu/garliccoin
- A third-party or self-compiled Garliccoin Core

upgrade to Garliccoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
