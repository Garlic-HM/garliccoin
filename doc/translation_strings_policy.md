...
This document provides guidelines for internationalization of the Garliccoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `garliccoin_en.ts` remains unchanged.
