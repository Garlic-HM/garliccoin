...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Garliccoin
else
  DOCKER_EXEC echo \> \$HOME/.garliccoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/garliccoin/garliccoin/pull/18288#discussion_r433189350 for
  # details.
