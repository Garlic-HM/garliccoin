# Bootstrappable Garliccoin Core Builds

This directory contains the files necessary to perform bootstrappable Garliccoin
Core builds.
...
From the top of a clean Garliccoin Core repository:
...
To use dongcarl's substitute server for Garliccoin Core builds after having
