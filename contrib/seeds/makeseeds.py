...
def main():
    ...
    # Filter out hosts with multiple garliccoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple garliccoin ports' % (ip_stats(ips)), file=sys.stderr)
