...
garliccoincore.org and garliccoin.org and compares them.
...
WORKINGDIR = "/tmp/garliccoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://garliccoincore.org"
HOST2 = "https://garliccoin.org"
VERSIONPREFIX = "garliccoin-core-"
...
def main(args):
    ...
    if not success:
        print("garliccoin.org failed to provide signature file, "
              "but garliccoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("garliccoin.org and garliccoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Garliccoin Core binary release "
