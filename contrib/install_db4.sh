#!/bin/sh
# Copyright (c) 2017-2019 The Garliccoin Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the garliccoin repository."
  exit 1
fi
...
# See https://github.com/garliccoin/garliccoin/issues/16064
...
echo 'When compiling garliccoind, run `./configure` in the following way:'
echo
