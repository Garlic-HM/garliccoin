#!/usr/bin/env python3
# Copyright (c) 2016-2019 The Garliccoin Core developers
...
libs = [
    'libgarliccoin_cli',
    'libgarliccoin_common',
    'libgarliccoin_crypto',
    'libgarliccoin_server',
    'libgarliccoin_util',
    'libgarliccoin_wallet_tool',
    'libgarliccoin_wallet',
    'libgarliccoin_zmq',
    'bench_garliccoin',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='Garliccoin-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/garliccoin_config.h'), os.path.join(SOURCE_DIR, 'config/garliccoin-config.h'))
