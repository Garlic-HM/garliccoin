...
// garliccoin includes.
#include <..\src\script\garliccoinconsensus.h>
...
int main()
{
    std::cout << "garliccoinconsensus version: " << garliccoinconsensus_version() << std::endl;
    ...
    auto op0Result = garliccoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, garliccoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
