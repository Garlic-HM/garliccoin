...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the GarliccoinTestFramework
    pass


class ExampleTest(GarliccoinTestFramework):
    # Each functional test is a subclass of the GarliccoinTestFramework class.
    ...
    def custom_method(self):
        ...
        GarliccoinTestFramework class so other tests can use it."""
