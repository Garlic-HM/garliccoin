...
class TestShell:
    """Wrapper Class for GarliccoinTestFramework.

    The TestShell class extends the GarliccoinTestFramework
    ...
    class __TestShell(GarliccoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by GarliccoinTestFramework child class.
            self.num_nodes = 1
