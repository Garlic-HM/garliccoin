...
class P2PPermissionsTests(GarliccoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].garliccoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].garliccoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
