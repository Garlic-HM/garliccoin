...
"""Verify that starting garliccoin with -h works as expected."""

from test_framework.test_framework import GarliccoinTestFramework
from test_framework.util import assert_equal

class HelpTest(GarliccoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start garliccoin with -h for help text")
        ...
        self.log.info("Start garliccoin with -version for version information")
        ...
        self.log.info("Start garliccoind with -fakearg to make sure it does not start")
