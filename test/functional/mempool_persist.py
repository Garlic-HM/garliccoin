...
By default, garliccoind will dump mempool on shutdown and
...
class MempoolPersistTest(GarliccoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent garliccoind from writing mempool.dat to disk. Verify that `savemempool` fails")
