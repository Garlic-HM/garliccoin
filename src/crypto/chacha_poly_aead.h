...
#ifndef GARLICCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define GARLICCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@garliccoin.
 *
 ...
 *
 * The chacha20-poly1305@garliccoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@garliccoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@garliccoin are relatively fast in
...
#endif // GARLICCOIN_CRYPTO_CHACHA_POLY_AEAD_H
