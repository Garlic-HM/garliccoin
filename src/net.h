...
#ifndef GARLICCOIN_NET_H
#define GARLICCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/garliccoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Garliccoin’s Peer-to-Peer Network")
