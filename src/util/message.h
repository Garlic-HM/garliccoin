...
#ifndef GARLICCOIN_UTIL_MESSAGE_H
#define GARLICCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's garliccoin address, it must refer to a public key.
...
#endif // GARLICCOIN_UTIL_MESSAGE_H
