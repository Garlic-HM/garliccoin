...
#ifndef GARLICCOIN_UTIL_SETTINGS_H
#define GARLICCOIN_UTIL_SETTINGS_H
...
//!       https://github.com/garliccoin/garliccoin/pull/15934/files#r337691812)
...
#endif // GARLICCOIN_UTIL_SETTINGS_H
