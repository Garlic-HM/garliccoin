...
#ifndef GARLICCOIN_COMPAT_ASSUMPTIONS_H
#define GARLICCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Garliccoin cannot be compiled without assertions."
#endif
...
#endif // GARLICCOIN_COMPAT_ASSUMPTIONS_H
