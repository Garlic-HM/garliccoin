...
#ifndef GARLICCOIN_IPC_PROCESS_H
#define GARLICCOIN_IPC_PROCESS_H
...
//! IPC process interface for spawning garliccoin processes and serving requests
...
#endif // GARLICCOIN_IPC_PROCESS_H
