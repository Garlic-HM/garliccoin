...
#ifndef GARLICCOIN_INTERFACES_NODE_H
#define GARLICCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a garliccoin node (garliccoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // GARLICCOIN_INTERFACES_NODE_H
