...
#ifndef GARLICCOIN_INTERFACES_INIT_H
#define GARLICCOIN_INTERFACES_INIT_H
...
//! (garliccoin-gui, garliccoin-node, garliccoin-wallet, garliccoind, garliccoin-qt) and each
...
#endif // GARLICCOIN_INTERFACES_INIT_H
