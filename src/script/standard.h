...
#ifndef GARLICCOIN_SCRIPT_STANDARD_H
#define GARLICCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a garliccoin address
 */
...
/**
 * Generate a Garliccoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // GARLICCOIN_SCRIPT_STANDARD_H
