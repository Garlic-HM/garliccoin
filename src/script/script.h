...
#ifndef GARLICCOIN_SCRIPT_SCRIPT_H
#define GARLICCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Garliccoin always counted CHECKMULTISIGs
...
#endif // GARLICCOIN_SCRIPT_SCRIPT_H
