...
#ifndef GARLICCOIN_PSBT_H
#define GARLICCOIN_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual Garliccoin transaction.) Returns true if the merge succeeded, false otherwise. */
