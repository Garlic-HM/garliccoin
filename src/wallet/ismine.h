...
#ifndef GARLICCOIN_WALLET_ISMINE_H
#define GARLICCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/garliccoin/garliccoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // GARLICCOIN_WALLET_ISMINE_H
