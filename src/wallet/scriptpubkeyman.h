...
#ifndef GARLICCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define GARLICCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Garliccoin Core wallet was originally a collection of unrelated private
...
#endif // GARLICCOIN_WALLET_SCRIPTPUBKEYMAN_H
