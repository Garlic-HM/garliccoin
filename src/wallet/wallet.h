...
#ifndef GARLICCOIN_WALLET_WALLET_H
#define GARLICCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this garliccoin node, and set to 0 for transactions that were created
...
#endif // GARLICCOIN_WALLET_WALLET_H
