...
#ifndef GARLICCOIN_WALLET_WALLETUTIL_H
#define GARLICCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! garliccoin from opening the wallet, thinking it was newly created, and
...
#endif // GARLICCOIN_WALLET_WALLETUTIL_H
