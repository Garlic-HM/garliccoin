...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, GarliccoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &GarliccoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &GarliccoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &GarliccoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &GarliccoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &GarliccoinGUI::updateWalletStatus);
    connect(gui, &GarliccoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
