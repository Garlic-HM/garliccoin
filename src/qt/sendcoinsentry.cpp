    ...
    platformStyle(_platformStyle)
{
    ...
    // normal garliccoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying garliccoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &GarliccoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
