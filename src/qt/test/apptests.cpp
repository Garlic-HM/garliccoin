...
//! Entry point for GarliccoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &GarliccoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for GarliccoinGUI tests.
void AppTests::guiTests(GarliccoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &GarliccoinGUI::consoleShown, this, &AppTests::consoleTests);
