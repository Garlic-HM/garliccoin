...
#ifndef GARLICCOIN_QT_GUIUTIL_H
#define GARLICCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Garliccoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "garliccoin:" URI into recipient object, return true on successful parsing
