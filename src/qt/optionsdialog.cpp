    ...
    mapper(nullptr)
{
    ...
    ui->garliccoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->garliccoinAtStartup);
    ...
    ui->garliccoinAtStartup->setToolTip(ui->garliccoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->garliccoinAtStartup->setText(ui->garliccoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openGarliccoinConfButton->setToolTip(ui->openGarliccoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new GarliccoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->garliccoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openGarliccoinConfButton_clicked()
{
