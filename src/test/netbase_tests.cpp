...
{
    BOOST_CHECK(TestSplitHost("www.garliccoincore.org", "www.garliccoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.garliccoincore.org]", "www.garliccoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.garliccoincore.org:80", "www.garliccoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.garliccoincore.org]:80", "www.garliccoincore.org", 80));
