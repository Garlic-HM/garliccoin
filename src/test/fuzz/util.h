// Copyright (c) 2009-2021 The Garliccoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GARLICCOIN_TEST_FUZZ_UTIL_H
#define GARLICCOIN_TEST_FUZZ_UTIL_H
...
#endif // GARLICCOIN_TEST_FUZZ_UTIL_H
