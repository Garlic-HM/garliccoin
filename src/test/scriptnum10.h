...
#ifndef GARLICCOIN_TEST_SCRIPTNUM10_H
#define GARLICCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Garliccoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // GARLICCOIN_TEST_BIGNUM_H
