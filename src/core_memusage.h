// Copyright (c) 2015-2018 The Garliccoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GARLICCOIN_CORE_MEMUSAGE_H
#define GARLICCOIN_CORE_MEMUSAGE_H
...
#endif // GARLICCOIN_CORE_MEMUSAGE_H
