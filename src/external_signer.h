// Copyright (c) 2018-2021 The Garliccoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GARLICCOIN_EXTERNAL_SIGNER_H
#define GARLICCOIN_EXTERNAL_SIGNER_H
...
public:
    ...
    //! Garliccoin mainnet, testnet, etc
    std::string m_chain;
...
#endif // GARLICCOIN_EXTERNAL_SIGNER_H
